...
class classPG_Rss extends classPG_ClassBasics
{
	...
	[de]Wenn sRssTemplate und sItemTemplate �bergeben wurden gibt die Methode ein Template als String zur�ck, oder einen Array wenn die Parameter nicht gesetzt wurden: %ReadFeedReturnArray%[/de]
