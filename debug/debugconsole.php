	...
	public function buildMessageContainer($_sSizeX = NULL, $_sSizeY = NULL)
	{
		...
		$_sHtml .= '<tr>';
			...
			$_sHtml .= $oPGButton->build(
				array(
					'sButtonID' => $this->getID().'ButtonJumpToTop',
			...
			$_sHtml .= $oPGButton->build(
				array(
					'sButtonID' => $this->getID().'ButtonJumpToNext',
			...
			$_sHtml .= $oPGButton->build(
				array(
					'sButtonID' => $this->getID().'ButtonJumpToActiveMessage',
			...
			$_sHtml .= $oPGButton->build(
				array(
					'sButtonID' => $this->getID().'ButtonJumpToPrevious',
			...
			$_sHtml .= $oPGButton->build(
				array(
					'sButtonID' => $this->getID().'ButtonJumpToBottom',
