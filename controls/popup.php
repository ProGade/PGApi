...
[de]Diese Klasse verf�gt �ber Methoden zum erstellen und anzeigen von HTML-Elementen als Popup.[/de]
...
class classPG_Popup extends classPG_ClassBasics
{
	...
	[de]Gibt das Popup als HTML String zur�ck.[/de]
	...
	[de]Der Inhalt f�r das Popup.[/de]
	...
	[de]Die Transparenz f�r den Hintergrund worauf das Popup dargestellt werden soll. Der Hintergrund wird abgedunkelt.[/de]
	...
	[de]Die Geschwindigkeit f�r das Abdunkeln des Hintergundes. Je gr��er die Zahl (in Millisekunden) um so langsamer der Effeckt.[/de]
	...
	[de]CSS Code f�r das Popup Element.[/de]
	
	@param sCssClass [type]string[/type]
	[en]CSS class for the popup element.[/en]
	[de]CSS Klasse f�r das Popup Element.[/de]
	*/
