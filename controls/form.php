...
[de]Die Klasse verf�gt �ber Methoden zum erstellen von Formularen.[/de]
...
class classPG_Form extends classPG_ClassBasics
{
	...
	*/
	...
	[de]Gibt Fehlermeldungen zum Sicherheitssystem zur�ck. Mit den Meldungen kann man erkennen was genau ein Sicherheitsproblem darstellt.[/de]
	
	@return axSecureErrors [type]mixed[][/type]
	[en]Returns error messages to the security system as an mixed array.[/en]
	[de]Gibt Fehlermeldungen zum Sicherheitssystem als gemischter Array zur�ck.[/de]
	*/
	...
	[de]Gibt an ob die Formulardaten �ber die Network-Funktionen der API gesendet werden sollen.[/de]
	...
	[de]Gibt an ob die Formulardaten �ber die Network-Funktionen der API gesendet werden sollen. Bei false werden die Daten auf traditionelle Weise per HTML Submit gesendet.[/de]
	*/
	...
	[de]Gibt zur�ck, ob die Formulardaten �ber die Netzwerk-Funktionen der API gesendet werden sollen.[/de]
	...
	[de]Gibt einen Boolean zur�ck, ob die Formulardaten �ber die Netzwerk-Funktionen der API gesendet werden sollen.[/de]
	*/
	...
	*/
	...
	[de]Gibt zur�ck, ob Formularfelder in JavaScript automatisch registriert werden sollen.[/de]
	...
	[de]Gibt einen Boolean zur�ck, ob Formularfelder in JavaScript automatisch registriert werden sollen.[/de]
	*/
	...
	[de]Gibt zur�ck, ob das Formular bereits abgeschickt wurde.[/de]
	
	@return bIsSend [type]bool[/type]
	[en]Returns a boolean whether the form was already sent.[/en]
	[de]Gibt einen Boolean zur�ck, ob das Formular bereits abgeschickt wurde.[/de]
	...
	*/
	...
	[de]Gibt die Aktion zur�ck, die nach dem senden des Formulars ausgef�hrt werden soll.[/de]
	*/
	...
	[de]Setzt den Sicherheitslevel der f�r das Loggen beim �bertragung des Formulars verwendet werden soll.[/de]
	...
	[/en]
	[de]
		Der Sicherheitslevel f�r das Loggen.
	...
	*/
	...
	[de]Gibt den Sicherheitslevel zum Loggen zur�ck.[/de]
	...
	[/en]
	[de]
		Gibt den Sicherheitslevel zum Loggen zur�ck.
		Folgende Defines sind m�glich:
		%FormSecureLogLevel%
	[/de]
	*/
	...
	[de]Setzt den Sicherheitslevel der f�r die �bertragung der Formulardaten verwendet werden soll.[/de]
	...
	[/en]
	[de]
		Der Sicherheitslevel f�r die �bertragung.
		Folgende Defines sind m�glich:
		%FormSecureActionLevel%
	[/de]
	*/
	...
	[de]Gibt den Sicherheitslevel f�r die �bertragung der Formulardaten zur�ck.[/de]
	...
	[/en]
	[de]
		Gibt den Sicherheitslevel f�r die �bertragung zur�ck.
		Folgende Defines sind m�glich:
		%FormSecureActionLevel%
	[/de]
	*/
	...
	*/
	...
	[de]Gibt zur�ck, ob beim Erstellen des Formulars die versteckten Felder durch Session Variablen ersetzt werden sollen.[/de]
	...
	[de]Gibt einen Boolean zur�ck, ob beim Erstellen des Formulars die versteckten Felder durch Session Variablen ersetzt werden sollen.[/de]
	*/
	...
	[de]F�gt dem Formular ein verstecktes Feld hinzu.[/de]
	
	@return iHiddenFieldIndex [type]int[/type]
	[en]Returns the index of the hidden field as an integer.[/en]
	[de]Gibt den Index des versteckten Feldes als Integer zur�ck.[/de]
	...
	*/
	...
	[de]F�gt dem Formular ein einzeiliges Eingabefeld oder Dropdown-Feld hinzu.[/de]
	
	@return iInputFieldIndex [type]int[/type]
	[en]Returns the index of the input field as an integer.[/en]
	[de]Gibt den Index des Eingabefeldes als Integer zur�ck.[/de]
	...
	[de]Die Datensatz ID im Hintergrund des Eingabefeldes. Wird verwendet, wenn ein Dropdown-Feld andere Daten als die Angezeigten �bergeben soll.[/de]
	...
	[de]Die Shortcut Taste �ber die, zusammen mit gedr�ckter ALT Taste, direkt in das Eingabefeld gesprungen werden kann.[/de]
	...
	[de]Die Datens�tze f�r die Dropdown-Feld option. Diese Datens�tze stehen in der Dropdown-Liste zur auswahl.[/de]
	
	@param sSendParameters [type]string[/type]
	[en]Parameters that are also sent on a auto save function.[/en]
	[de]Parameter die bei einer Autosave Funktion zus�tzlich gesendet werden.[/de]
	
	@param sOnFieldBlur [type]string[/type]
	[en]JavaScript code to be executed when the input field was abandoned.[/en]
	[de]JavaScript Code der ausgef�hrt werden soll, wenn das Eingabefeld verlassen wurde.[/de]
	
	@param sOnFieldFocus [type]string[/type]
	[en]JavaScript code to be executed when the input field is selected.[/en]
	[de]JavaScript Code der ausgef�hrt werden soll, wenn das Eingabefeld angew�hlt wird.[/de]
	...
	[de]JavaScript Code der ausgef�hrt werden soll, wenn das Eingabefeld angew�hlt ist und eine Taste gedr�ckt wird.[/de]
	...
	[de]JavaScript Code der ausgef�hrt werden soll, wenn das Eingabefeld angew�hlt ist und eine Taste wieder losgelassen wurde.[/de]
	
	@param sOnFieldClick [type]string[/type]
	[en]JavaScript code which will be executed, when the input field was clicked.[/en]
	[de]JavaScript Code der ausgef�hrt werden soll, wenn auf das Eingabefeld geklickt wurde.[/de]
	...
	[de]JavaScript Code der ausgef�hrt werden soll, wenn auf das Eingabefeld gerade geklickt wird.[/de]
	...
	[de]JavaScript Code der ausgef�hrt werden soll, wenn der Mauszeiger �ber das Eingabefeld bewegt wird.[/de]
	...
	[de]JavaScript Code der ausgef�hrt werden soll, wenn der Mauszeiger von dem Eingabefeld weg bewegt wird.[/de]
	...
	[de]JavaScript Code der ausgef�hrt werden soll, wenn ein Datensatz aus der Dropdown-Liste ausgew�hlt wird.[/de]
	...
	[de]JavaScript Code der ausgef�hrt werden soll, wenn der Bearbeitungsmodus f�r Datens�tze der Dropdown-Liste gewechselt wird.[/de]
	...
	[de]JavaScript Code der ausgef�hrt werden soll, wenn ein neuer Datensatz f�r die Dropdown-Liste erstellt wird.[/de]
	
	@param sOnDatasetUpdate [type]string[/type]
	[en]JavaScript code to be executed when a dataset is modified.[/en]
	[de]JavaScript Code der ausgef�hrt werden soll, wenn ein Datensatz ge�ndert wird.[/de]
	
	@param sOnDatasetDelete [type]string[/type]
	[en]JavaScript code to be executed when a dataset is deleted.[/en]
	[de]JavaScript Code der ausgef�hrt werden soll, wenn ein Datensatz gel�scht wird.[/de]
	*/
	...
	[de]F�gt dem Formular ein Textfeld hinzu.[/de]
	
	@return iTextAreaIndex [type]int[/type]
	[en]Returns the index of the textarea as an integer.[/en]
	[de]Gibt den Index des Textfeldes als Integer zur�ck.[/de]
	...
	[de]Die Anzahl an Zeilen die Sichtbar sind und die H�he des Textfeldes vorgeben.[/de]
	...
	[de]Die Shortcut Taste �ber die, zusammen mit gedr�ckter ALT Taste, direkt in das Textfeld gesprungen werden kann.[/de]
	...
	[de]Die Anzahl an Zeilenumbr�che die erlaubt sind. Bei 0 gibt es keine Begrenzung der Zeilenumbr�che.[/de]
	...
	[de]Die Anzahl an Leerzeichen die erlaubt sind. Bei 0 gibt es keine Begrenzung der Leerzeichen. Kann verwendet werden um die Anzahl an W�rtern zu begrenzen.[/de]
	...
	[de]JavaScript Code der ausgef�hrt werden soll, wenn das Textfeld verlassen wurde.[/de]
	
	@param sOnFocus [type]string[/type]
	[en]JavaScript code to be executed when the textarea is selected.[/en]
	[de]JavaScript Code der ausgef�hrt werden soll, wenn das Textfeld angew�hlt wird.[/de]
	...
	[de]JavaScript Code der ausgef�hrt werden soll, wenn das Textfeld angew�hlt ist und eine Taste gedr�ckt wird.[/de]
	
	@param sOnKeyUp [type]string[/type]
	[en]JavaScript code to be executed when the textarea is selected and a key was released.[/en]
	[de]JavaScript Code der ausgef�hrt werden soll, wenn das Textfeld angew�hlt ist und eine Taste wieder losgelassen wurde.[/de]
	
	@param sOnClick [type]string[/type]
	[en]JavaScript code which will be executed, when the textarea was clicked.[/en]
	[de]JavaScript Code der ausgef�hrt werden soll, wenn auf das Textfeld geklickt wurde.[/de]
	
	@param sOnMouseDown [type]string[/type]
	[en]JavaScript code which will be executed, when the textarea is being clicked.[/en]
	[de]JavaScript Code der ausgef�hrt werden soll, wenn auf das Textfeld gerade geklickt wird.[/de]
	...
	[de]JavaScript Code der ausgef�hrt werden soll, wenn der Mauszeiger �ber das Textfeld bewegt wird.[/de]
	...
	[de]JavaScript Code der ausgef�hrt werden soll, wenn der Mauszeiger von dem Textfeld weg bewegt wird.[/de]
	*/
	...
	[de]F�gt dem Formular eine Checkbox hinzu.[/de]
	
	@return iCheckBoxIndex [type]int[/type]
	[en]Returns the index of the checkbox as an integer.[/en]
	[de]Gibt den Index der Checkbox als Integer zur�ck.[/de]
	...
	[de]Die Statusstrukturen die durch $oPGCheckBox->buildStatusStructure(...) erstellt werden. Gibt an welche Status-Stufen eingestellt werden k�nnen.[/de]
	...
	[de]JavaScript Code der ausgef�hrt werden soll, wenn auf die Checkbox geklickt wurde.[/de]
	
	@param sOnMouseDown [type]string[/type]
	[en]JavaScript code which will be executed, when the checkbox is being clicked.[/en]
	[de]JavaScript Code der ausgef�hrt werden soll, wenn auf die Checkbox gerade geklickt wird.[/de]
	...
	[de]JavaScript Code der ausgef�hrt werden soll, wenn der Mauszeiger �ber die Checkbox bewegt wird.[/de]
	
	@param sOnMouseOut [type]string[/type]
	[en]JavaScript code to be executed when the mouse pointer moves away from the checkbox.[/en]
	[de]JavaScript Code der ausgef�hrt werden soll, wenn der Mauszeiger von der Checkbox weg bewegt wird.[/de]
	*/
	...
	*/
	...
	[de]Erstellt das Formular und gibt es als HTML String zur�ck.[/de]
	
	@return sFormHtml [type]string[/type]
	[en]Returns the form as an HTML string.[/en]
	[de]Gibt das Formular als HTML String zur�ck.[/de]
	...
	[de]Die Methode �ber die das Formular gesendet werden soll. M�glich sind "get" und "post". (Standard: post)[/de]
	...
	[de]Versteckte Felder die bei Sicherheitspr�fungen ausgelassen (ignoriert) werden sollen.[/de]
	...
	[de]JavaScript Code der beim Abschicken des Formulars ausgef�hrt werden soll.[/de]
	
	@param sOnAbort [type]string[/type]
	[en]JavaScript code to be executed when aborting the form.[/en]
	[de]JavaScript Code der beim Abbrechen des Formulars ausgef�hrt werden soll.[/de]
	*/
	...
	*/
	...
	[de]Gibt die abgeschickten Daten des Formulars zur�ck.[/de]
	
	@return axData [type]mixed[][/type]
	[en]Returns the submitted data of the form as an mixed array.[/en]
	[de]Gibt die abgeschickten Daten des Formulars als gemischten Array zur�ck.[/de]
	...
	[de]Die Sende-Methode des Formulars von der die gesendeten Daten abgegriffen werden sollen. M�glich sind "get" und "post". (Standard: post)[/de]
	...
	[de]Gibt an ob die Daten f�r Datenbankabfragen optimiert werden sollen. Bei "true" werden die Daten mit realEscapeString(...) �berarbeitet.[/de]
	*/
	...
	[de]Checkt ob die Session noch l�uft und in Ordnung ist.[/de]
	...
	[de]Gibt bei einer fehlerhaften oder abgelaufenen Session "false" zur�ck oder bricht das ganze Script ab. Bei laufender Session die in Ordnung ist, wird der Token der Session als String zur�ckgegeben.[/de]
	...
	[de]Der Token der Session kann zur �berpr�fung angegeben werden. Ansonsten wird ein Token der laufenden Session aus den Formulardaten geholt.[/de]
	
	@param sFormMethod [type]string[/type]
	[en]The send method of the form provides to access form data.[/en]
	[de]Die Sende-Methode des Formulars, �ber die Formulardaten abgegriffen werden sollen.[/de]
	*/
	...
	[de]Gibt die Daten zu einem Token der Session zur�ck.[/de]
	
	@return axData [type]mixed[][/type]
	[en]Returns the data of the session due to the token.[/en]
	[de]Gibt die Daten der Session passend zum Token zur�ck.[/de]
	...
	*/
	...
	[de]Gibt den neuen Token als String zur�ck.[/de]
	...
	[de]Ein Token kann angegeben werden, wenn ein bestimmter String daf�r verwendet werden soll. Bei "NULL" wird ein neuer zuf�llig generiert.[/de]
	...
	*/
	...
	[de]Der Token der entfernt werden soll. Bei "NULL" wird die komplette Session f�r das Formular gel�scht.[/de]
	*/
