...
[de]Diese Klasse verf�gt �ber Methoden zum erstellen von Seitennavigationen.[/de]
...
class classPG_PageControl extends classPG_ClassBasics
{
	...
	*/
	...
	[de]Gibt die Seitennavigation als HTML String zur�ck.[/de]
	...
	[de]Die Seite die gerade ausgew�hlt ist.[/de]
	
	@param iPagesToShow [type]int[/type]
	[en]The number of pages that are directly selectable in navigation.[/en]
	[de]Die Anzahl an Seiten die bei der Navigation direkt anw�hlbar sind.[/de]
	...
	[de]Der Text f�r die vorherige Seite.[/de]
	
	@param sNextPageText [type]string[/type]
	[en]The text for the next page.[/en]
	[de]Der Text f�r die n�chste Seite.[/de]
	*/
	...
	[de]Setzt die Anzahl an Seiten die bei der Navigation direkt anw�hlbar sind.[/de]
	...
	*/
	...
	[de]Setzt die Seite die gerade ausgew�hlt ist.[/de]
	...
	*/
	...
	[de]Setzt die CSS Klasse f�r die aktive Seite.[/de]
	
	@param sClass [needed][type]string[/type]
	[en]The CSS class for the active page.[/en]
	[de]Die CSS Klasse f�r die aktive Seite.[/de]
	*/
	...
	[de]Setzt die CSS Klasse f�r die nicht aktiven Seiten.[/de]
	
	@param sClass [needed][type]string[/type]
	[en]The CSS class for the not active pages.[/en]
	[de]Die CSS Klasse f�r die nicht aktiven Seiten.[/de]
	*/
	...
	[de]Setzt die CSS Code f�r die aktive Seite.[/de]
	
	@param sStyle [needed][type]string[/type]
	[en]The CSS code for the active page.[/en]
	[de]Die CSS Code f�r die aktive Seite.[/de]
	*/
	...
	[de]Setzt die CSS Code f�r die nicht aktiven Seiten.[/de]
	
	@param sStyle [needed][type]string[/type]
	[en]The CSS code for the not active pages.[/en]
	[de]Die CSS Code f�r die nicht aktiven Seiten.[/de]
	*/
