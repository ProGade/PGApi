...
class classPG_ClassBasics
{
	...
	*/
	...
	{
		$_sID = $this->getRealParameter(array('oParameters' => $_sID, 'sName' => 'sID', 'xParameter' => $_sID));
		$this->sID = $_sID;
	}
	/* @end method */
	...
	*/
	...
	{
		$_sText = $this->getRealParameter(array('oParameters' => $_xType, 'sName' => 'sText', 'xParameter' => $_sText));
		$_xType = $this->getRealParameter(array('oParameters' => $_xType, 'sName' => 'xType', 'xParameter' => $_xType, 'bNotNull' => true));
	...
	*/
	...
	{
		$_sText = $this->getRealParameter(array('oParameters' => $_sType, 'sName' => 'sText', 'xParameter' => $_sText));
	...
	*/
	...
	{
		$_iCurrentMode = $this->getRealParameter(array('oParameters' => $_iMode, 'sName' => 'iCurrentMode', 'xParameter' => $_iCurrentMode));
	...
	*/
	...
	{
		$_oGfx = $this->getRealParameter(array('oParameters' => $_oGfx, 'sName' => 'oGfx', 'xParameter' => $_oGfx));
	...
	*/
	...
	{
		$_oNetwork = $this->getRealParameter(array('oParameters' => $_oNetwork, 'sName' => 'oNetwork', 'xParameter' => $_oNetwork));
	...
	*/
	...
	{
		$_oTemplate = $this->getRealParameter(array('oParameters' => $_oTemplate, 'sName' => 'oTemplate', 'xParameter' => $_oTemplate));
	...
	*/
	...
	{
		$_oMySql = $this->getRealParameter(array('oParameters' => $_oDatabase, 'sName' => 'oMySql', 'xParameter' => $_oMySql));
		$_oMsSql = $this->getRealParameter(array('oParameters' => $_oDatabase, 'sName' => 'oMsSql', 'xParameter' => $_oMsSql));
		$_oMongo = $this->getRealParameter(array('oParameters' => $_oDatabase, 'sName' => 'oMongo', 'xParameter' => $_oMongo));
		$_oDatabase = $this->getRealParameter(array('oParameters' => $_oDatabase, 'sName' => 'oDatabase', 'xParameter' => $_oDatabase));
	...
	*/
	...
	{
		$_sPrefix = $this->getRealParameter(array('oParameters' => $_sPrefix, 'sName' => 'sPrefix', 'xParameter' => $_sPrefix));
	...
	*/
	public function getDatasetsRowCount($_xResult = NULL, $_sEngine = NULL)
	{
		...
		$_xResult = $this->getRealParameter(array('oParameters' => $_xResult, 'sName' => 'xResult', 'xParameter' => $_xResult));
    ...
    */
    public function selectDatabaseFiles($_xFileID = NULL, $_asMetadata = NULL, $_xWhere = NULL, $_sEngine = NULL)
    {
        ...
        $_sEngine = $this->getRealParameter(array('oParameters' => $_xFileID, 'sName' => 'sEngine', 'xParameter' => $_sEngine));
	...
	*/
	...
	{
		$_sTarget = $this->getRealParameter(array('oParameters' => $_sTarget, 'sName' => 'sTarget', 'xParameter' => $_sTarget));
	...
	*/
	...
	{
		$_axParameters = $this->getRealParameter(array('oParameters' => $_axParameters, 'sName' => 'axParameters', 'xParameter' => $_axParameters, 'bNotNull' => true));
	...
	*/
	...
	{
		$_bUseLineBreak = $this->getRealParameter(array('oParameters' => $_bUseLineBreak, 'sName' => 'bUseLineBreak', 'xParameter' => $_bUseLineBreak));
