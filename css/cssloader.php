 ...
 * [de]Diese Klasse verf�gt �ber Methoden zum laden von CSS Dateien.[/de]
 *
...
class classPG_CssLoader extends classPG_ClassBasics
{
     ...
     * [/en]
     * [de]
     *     Setzt den R�ckfall System Basis-Pfad f�r alle CSS Dateien die geladen werden sollen.
     ...
     * [de]Der Pfad als Basis aller Dateien beim eintreten des R�ckfall Systems.[/de]
     */
     ...
     * [de]Gibt den R�fall System Basis-Pfad f�r alle CSS Dateien zur�ck.[/de]
     *
     ...
     * [de]Setzt den Basis-Pfad f�r alle CSS Dateien die geladen werden sollen.[/de]
     *
     * @param sPath [needed][type]string[/type]
     ...
     * [de]Gibt den Basis-Pfad f�r alle CSS Dateien zur�ck.[/de]
     *
     * @return sFilesPath [type]string[/type]
     * [en]Returns the path as a string.[/en]
     * [de]Gibt den Pfad als String zur�ck.[/de]
