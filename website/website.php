...
class classPG_Website extends classPG_ClassBasics
{
	...
	*/
	...
	[de]F�gt eine CSS Datei, die geladen werden soll, hinzu.[/de]
	...
	*/
	...
	[de]F�gt eine JavaScript Datei, die geladen werden soll, hinzu.[/de]
	...
	*/
	...
	[de]F�gt eine JavaScript API Datei, die geladen werden soll, hinzu.[/de]
	...
	*/
	...
	)
	{
        ...
        $_sHeadContent = $this->getRealParameter(array('oParameters' => $_xTemplate, 'sName' => 'sHeadContent', 'xParameter' => $_sHeadContent));
        ...
        if ($_sHeadContent === NULL) {$_sHeadContent = $this->sHeadContent;}
