...
*/
class classPG_DeliciousShare extends classPG_ClassBasics
{
	// Declarations...
	private $sUrlToShare = '';
	private $sTextToShare = '';
	private $sShareOnUrl = 'http://www.delicious.com/save';
	private $sButtonImage = 'delicious_share.png';
	...
	public function __construct()
	{
		...
		$this->setText(array(
			'ShareLinkText' => 'share on delicious'
		));
	}
	...
	*/
	public function build($_sUrlToShare = NULL, $_sTextToShare = NULL)
	{
		...
		$_sHTML .= '&amp;noui';
		$_sHTML .= '&amp;jump=close';
		$_sHTML .= '\', '.$this->iPopupWindowSizeX.', '.$this->iPopupWindowSizeY.', \'delicious_share\', ';
...
/* @end class */
$oPGDeliciousShare = new classPG_DeliciousShare();
if (isset($oPGApi)) {$oPGApi->register(array('sName' => 'oPGDeliciousShare', 'xValue' => $oPGDeliciousShare));}
?>