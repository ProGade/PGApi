...
*/
class classPG_LinkedInShare extends classPG_ClassBasics
{
	// Declarations...
	private $sUrlToShare = '';
	private $sTextToShare = '';
	private $sShareOnUrl = 'http://www.linkedin.com/shareArticle';
	private $sButtonImage = 'linkedin_share.png';
	...
	public function __construct()
	{
		...
		$this->setText(array(
			'ShareLinkText' => 'share on linkedin'
		));
	}
	...
	*/
	public function build($_sUrlToShare = NULL, $_sTextToShare = NULL)
	{
		...
		$_sHTML .= '\', '.$this->iPopupWindowSizeX.', '.$this->iPopupWindowSizeY.', \'linkedin_share\', ';
...
/* @end class */
$oPGLinkedInShare = new classPG_LinkedInShare();
if (isset($oPGApi)) {$oPGApi->register(array('sName' => 'oPGLinkedInShare', 'xValue' => $oPGLinkedInShare));}
?>