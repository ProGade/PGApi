...
*/
class classPG_FacebookShare extends classPG_ClassBasics
{
	// Declarations...
	private $sUrlToShare = '';
	private $sTextToShare = '';
	private $sShareOnUrl = 'http://www.facebook.com/share.php';
	private $sButtonImage = 'facebook_share.png';
	...
	public function __construct()
	{
		...
		$this->setText(array(
			'ShareLinkText' => 'share on facebook'
		));
	}
...
/* @end class */
$oPGFacebookShare = new classPG_FacebookShare();
if (isset($oPGApi)) {$oPGApi->register(array('sName' => 'oPGFacebookShare', 'xValue' => $oPGFacebookShare));}
?>