...
class classPG_Imap extends classPG_ClassBasics
{
	...
	*/
	public function imapUTF7SpecialChars($_sString)
	{
		...
		$_sString = str_replace("�", "&AOQ-", $_sString);
		$_sString = str_replace("�", "&APY-", $_sString);
		$_sString = str_replace("�", "&APw-", $_sString);
		$_sString = str_replace("�", "&AMQ-", $_sString);
		$_sString = str_replace("�", "&ANY-", $_sString);
		$_sString = str_replace("�", "&ANw-", $_sString);
		$_sString = str_replace("�", "&AN8-", $_sString);
